...
from ai_agents.utils import security
from ai_agents.resume_extractor_agent import config
# Load configuration
...
class ResumeAgent:
    def __init__(self, apiKey, modelName, systemPrompt, useDefaultModelIfNone=True, useDefaultSystemPromptIfNone=True):
        ...
        if useDefaultSystemPromptIfNone and systemPrompt is None:
            ...
            try:
                with importlib.resources.open_text('ai_agents.resume_extractor_agent.data', systemPromptPath) as file:
